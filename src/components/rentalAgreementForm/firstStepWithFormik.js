                                ...
                                <div className="container my-2">
                                    <div className="row">
                                        <div className="col-6 col-lg-6 col-md-6 col-sm-12">
                                            ...
                                            <RadioButtonGroup
                                                id="tenantIsA"
                                                value={values.tenantIsA}
                                                error={errors.tenantIsA}
                                                touched={touched.tenantIsA}
                                            >
                                                <div className={`input-group mb-0 mt-2 ${errors.tenantIsA && touched.tenantIsA ? 'input-group-alert' : ''}`}>
                                                    <div className="btn-group btn-group-options btn-group-options-highlight-2 m-b-1">
                                                        {tenantIsAOpt.map((opt) => (
                                                            <label className="btn btn-group-radio"
                                                                htmlFor={opt.id}
                                                                key={opt.id}>
                                                                <Field
                                                    ...
                                                    {errors.tenantIsA && touched.tenantIsA && <small className="feedback">{errors.tenantIsA}<span role="img" aria-label="confuse emoji">&#x1F633;</span></small>}
                                                </div>
                                            </RadioButtonGroup>
                                        ...
                                        <div className="col-6 col-lg-6 col-md-6 col-sm-12">
                                            ...
                                            <RadioButtonGroup
                                                id="ownerIsA"
                                                value={values.ownerIsA}
                                                error={errors.ownerIsA}
                                                touched={touched.ownerIsA}
                                            >
                                                <div className={`input-group mb-0 mt-2 ${errors.ownerIsA && touched.ownerIsA ? 'input-group-alert' : ''}`}>
                                                    <div className="btn-group btn-group-options btn-group-options-highlight-2 m-b-1">
                                                        {ownerIsAOpt.map((opt) => (
                                                            <label className="btn btn-group-radio"
                                                                htmlFor={opt.id}
                                                    ...
                                                    {errors.ownerIsA && touched.ownerIsA && <small className="feedback">{errors.ownerIsA}<span role="img" aria-label="confuse emoji">&#x1F633;</span></small>}
                                                </div>
                                            </RadioButtonGroup>
...
const formikFirstStep = withFormik({
    mapPropsToValues({ tenantTitle, tenantName, tenantIsA, tenantFatherHusbandName, tenantAddress, ownerTitle, ownerName, ownerIsA, ownerFatherHusbandName, ownerAddress, advanceAmount, monthlyRent, rentedPropertyAddress, agreementDate }) {
        return {
    ...
    validationSchema: Yup.object().shape({
        tenantTitle: Yup.string().required('Please select one of the above title.'),
        tenantName: Yup.string().max(40, 'Please keep the name short!.').required('Please enter your tenant name.'),
        tenantIsA: Yup.string().required('Please select one of the above title.'),
        ...
        ownerTitle: Yup.string().required('Please select one of the above title.'),
        ownerName: Yup.string().max(40, 'Please keep the name short!.').required('Please enter your owner name'),
        ownerIsA: Yup.string().required('Please select one of the above title.'),
